            ...
            <table class="table table-dark table-striped">
                <tr>
                 ...
                 <c:forEach var="item" items="${productos}">
                    ...
                    <td>${item.precio}</td>
                    <td>${item.existenciaAlm}</td>
                    <td><a href="ProductoControlador?action=edit&id=${item.id}"><i class="fa-solid fa-pen-to-square"></i></a></td>
                    <td><a href="ProductoControlador?action=delete&id=${item.id}"onclick="return(confirm('Esta seguro de eliminar ?'))"><i class="fa-regular fa-trash-can"></i></a></td>
                </tr>
                </c:forEach>
            </table>
        </div>
